        ...
        <div className="py-3 px-10 sm:px-4 md:px-6 lg:px-6 container mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="lg:flex hidden gap-8 items-center">
              ...
              <a href="" className='text-[#191919] text-xl font-medium hover:text-red-500'>Why us </a>
      ...
      <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-red-100 shadow">
        <div className="card-body">
          ...
          <div className="card-actions">
            <Link to="/viewcart">
          <button className='bg-[#FDC55E] active:scale-90 transition duration-150 transform
              ...
              {user ? (
                ...
                <Link to="/login">
                  <button className='bg-[#FDC55E] active:scale-90 transition duration-100 transform hover:shadow-xl shadow-md rounded-full px-8 py-2 text-xl font-medium text-white'>Login</button>
                </Link>
              )}
            </div>
