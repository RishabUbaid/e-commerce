        ...
        <div className="container mx-auto py-6">
          <div className="w-full bg-white px-10 py-5 text-black rounded-md">
            ...
            <div className="mt-10 flex mb-5">
              ...
              <h3 className="font-semibold text-gray-900 text-xs uppercase w-2/5">Category</h3>
              <h3 className="font-semibold text-gray-900 text-xs uppercase w-2/5">Price</h3>
              <h3 className="font-semibold text-gray-900 text-xs uppercase w-2/5">Total Price</h3>
            </div>
...
const CartProduct = ({ product }) => {
  ...
  return (
    <div className='flex items-center hover:bg-gray-100 -mx-8 px-6 py-5'>
      <div className="flex">
        ...
        <div className="flex flex-col justify-between ml-4 flex-grow">
          ...
          <span className='flex items-center space-x-4'>
            ...
            <span className="text-red-500 px-3 py-2 bg-slate-100 text-lg font-medium">{product.qty}</span>
      ...
      <span className='font-bold text-center w-1/5 text-sm'>{product.price} x {product?.qty}</span>
      <span className="font-bold text-center w-1/5 text-sm">{product.qty * product.price}</span>
    </div>
  );
}
