            ...
            <div className='bg-gray-300 border rounded mb-5 p-8 text-black' >
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-6 sm:space-y-0 sm:gap-5 sm:mx-auto sm:justify-center">
                <button className='bg-white active:scale-90 transition duration-500 transform
                        hover:shadow-xl shadow-md rounded-full px-8 py-2 text-xl font-medium text-[#2e2e2e] '>
                  Favourite
                </button>
                <button className='bg-[#6b6b6b] active:scale-90 transition duration-500 transform
