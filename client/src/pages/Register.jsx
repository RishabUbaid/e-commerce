    ...
    return (
        <div className='register'>
            <div className='w-full mx-auto pt-[16vh]'>
                ...
                bg-gray-200/80 lg:w-max mx-auto rounded-md px-8 py-5' onSubmit={handleOnSubmit}>
                    ...
                    <div className='mb-3'>
                        ...
                        <input type="text" name='type' placeholder='Please Enter' className='shadow-sm bg-white appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' />
                    </div>
                    ...
                    <button className='bg-green-300 active:scale-90 transition duration-150 transform hover:shadow-xl shadow-md w-full rounded-full px-8 py-2 text-xl font-medium text-white mx-auto text-center mb-3 mt-5' type='submit'>Sign In</button>

                    <Link to="/login" className="text-[#fdc55e] text-center font-semibold w-full mb-3 py-2 px-4 rounded">Already have an account? Login here</Link>
                    <ToastContainer />
                </form>
            </div>
        </div>
